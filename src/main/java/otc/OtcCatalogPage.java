...
public class OtcCatalogPage extends BasePage {
    ...
    private final ElementsCollection products = $$(PRODUCT_CSS).as("Карточки товаров");
    ...
    public String getProductName(SelenideElement product) {
        return product.find(By.cssSelector(PRODUCT_NAME_CSS)).as("Название товара").getText();
    }
    ...
    public String getProductPrice(SelenideElement product) {
        return product.find(By.cssSelector(PRICE_NAME_CSS)).as("Цена товара").getText();
    }
}